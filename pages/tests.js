...
const Tests = () => {
   ...
   const handleSubmit = async (e) => {
      ...
      setError("");
      try {
         await setDoc(doc(db, "test-results", id), {
            ...score,
         });
               ...
               {showResults ? (
                  <>
                     <span className="text-md font-serif text-red-600 p-2 m-2">
                        Внимание! Результаты и интерпретации, полученные без
                        участия специалистов, не следует воспринимать слишком
                        серьезно. Диагностическую ценность имеют только
                        исследования, проведенные профессиональным психологом.
                     </span>
                     <div
              ...
              bg-slate-50 font-mono text-slate-700 p-4"
                     >
                        ...
                        <div className="text-left text-lg font-serif">
                           <p>
                              Далее, вы можете увидеть краткое описание вашего
                              результата:
                           </p>
                           <p>
                              Если количество очков(в одной шкале) меньше -2
                              (минус два) - пожалуйста, немедленно обратитесь в
                              Бесплатный круглосуточный телефон неотложной
                              психологической помощи - +37360491200. После того
                              как вы обратились за помощью, пожалуйста,
                              запишитесь на прием к специалисту. Когда ваше
                              состояние улучшиться и не будет критическим,
                              пожалуйста, пройдите тест еще раз и мы подберем
                              вам лучшую программу для поддержки здоровья.
                           </p>
                           <p>
                              Если количество очков около нуля - это означает,
                              что вам необходима консультация с профессионалом.
                              Возможно ваша ситуация на данный момент не самая
                              лучшая, однако вы справитесь и у вас все
                              получиться.
                           </p>
                           <p>
                              Если количество очков больше или равно 5, значит
                              конкретно этот параметр находится в отличном
                              состоянии, и его необходимо лишь поддерживать для
                              счастливой жизни.
                           </p>
                        </div>
                        {user ? (
                        ...
                        {questions[currentQuestion].options.map((option) => {
                           return (
                              <li
                                 key={option.id}
                                 onClick={() =>
                                    optionClicked(option.type, option.score)
                                 }
