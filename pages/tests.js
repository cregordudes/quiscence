          ...
          >
            ...
            <div className="text-left text-lg font-serif">
              ...
              <p>
                ...
                пожалуйста, немедленно обратитесь в Бесплатный круглосуточный
                телефон неотложной психологической помощи - +37360491200. После
                того как вы обратились за помощью, пожалуйста, запишитесь на
                прием к специалисту. Когда ваше состояние улучшиться и не будет
                критическим, пожалуйста, пройдите тест еще раз и мы подберем вам
                лучшую программу для поддержки здоровья.
              </p>
              <p>
                Если количество очков около нуля - это означает, что вам
                необходима консультация с профессионалом. Возможно ваша ситуация
                на данный момент не самая лучшая, однако вы справитесь и у вас
                все получиться.
              </p>
              <p>
                Если количество очков больше или равно 5, значит конкретно этот
                параметр находится в отличном состоянии, и его необходимо лишь
                поддерживать для счастливой жизни.
              </p>
            </div>
            {user ? (
              <button
