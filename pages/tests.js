         ...
         {showResults ? (
            <>
               <span className="text-md font-serif text-red-600 p-2 m-2">
                  ...
                  Диагностическую ценность имеют только исследования,
                  проведенные профессиональным психологом.
               </span>
               <div
            ...
            bg-slate-50 font-mono text-slate-700 p-4"
               >
                  ...
                  <div className="text-left text-lg font-serif">
                     ...
                     <p>
                        Если количество очков(в одной шкале) меньше -2 (минус
                        два) - пожалуйста, немедленно обратитесь в Бесплатный
                        круглосуточный телефон неотложной психологической помощи
                        - +37360491200. После того как вы обратились за помощью,
                        пожалуйста, запишитесь на прием к специалисту. Когда
                        ваше состояние улучшиться и не будет критическим,
                        пожалуйста, пройдите тест еще раз и мы подберем вам
                     ...
                     <p>
                        ...
                        конкретно этот параметр находится в отличном состоянии,
                        и его необходимо лишь поддерживать для счастливой жизни.
                     </p>
                  </div>
                  {user ? (
                     <button
